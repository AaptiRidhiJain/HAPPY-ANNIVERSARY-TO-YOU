...
var count = 0;
var door;
var dingSound,haanMainGalat;
var fallingHearts;
var fallingFlowers,flowerImage;
var fallingBalloons,balloonImage;
...
function preload(){
  ...
  haanMainGalat = loadSound("Haan main galat.mp3");
...
function spawnFlowers(){
  if(gameState === 0){
    if(frameCount % 20 === 0){
      var rand = Math.round(random(10,590));
      fallingFlowers = createSprite(rand,-10,1,1);
      fallingFlowers.addImage(flowerImage);
      fallingFlowers.scale = 0.09;
      fallingFlowers.velocityY = 3;
      fallingFlowers.lifeTime = 100;
    }
  }
}
...
function spawnBallons(){
  if(gameState === 0){
    if(frameCount % 20 === 0){
      var rand = Math.round(random(10,590));
      fallingBalloons = createSprite(rand,-10,1,1);
      fallingBalloons.addImage(balloonImage);
      fallingBalloons.scale = 0.1;
      fallingBalloons.velocityY = 3;
      fallingBalloons.lifeTime = 100;
    }
  }
}